  ...
  return (
    <div className='w-full  flex flex-col gap-2'>
        <div className='flex flex-col md:flex-row'>
                    ...
                    <p className='pt-2 font-light text-gray-700'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis quibusdam necessitatibus ut fugit voluptatibus ea ipsum, molestias, impedit, voluptatum repellat enim odio sed harum nostrum tenetur deleniti veniam doloribus ab?</p>

                        </div>
                    <div className='border-1 flex flex-3 p-2 m-2 border-gray-300 shadow-md  rounded-md'>
                        <Image  src="/image2.png" width={200} height={100} className='rounded-md' />
                        <p className='p-2 font-light text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores corrupti vitae perspiciatis earum nam,
        ...
        <div className='flex items-center justify-between w-full border-0 rounded-full  mt-15'>
            ...
            <div className='w-full mx-2  md:w-auto'>
                 <button className='w-full border-1 rounded-full p-2 font-semibold'>See All</button>
            </div>
        </div>
        ...
        <div className='grid md:grid-cols-10 md:grid-rows-1 gap-2 m-1 text-white mb-20 '>
            <div className='image-Bg md:col-span-4 col-span-3 min-h-[20vh] rounded-md  shadow-md'>
                <p className='text-2xl font-bold text-white text-center p-4'>Pet friendly plants</p>
             ...
             <div className='image-Bg col-span-3 rounded-md'>
                <p className='text-2xl font-bold text-white text-center p-4'>Orchids</p>

                <p className='py-3 text-center p-3'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Natus error eum vitae maxime hic quas quaerat
                    l officia.Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
             ...
             <div className='image-Bg col-span-3 rounded-md '>
                <p className='text-2xl font-bold text-white text-center p-4'>Succulents</p>

                <p className='py-3 text-center p-6'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Natus error eum vitae maxime hic quas quaerat
                     Lorem ipsum, dolor sit amet consectetur adipisicing elit. vel officia.</p>
       ...
       <div className='flex md:flex-row flex-col items-center justify-between gap-2 mx-5 my-10'>
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Itaque aspernatur commodi deserunt asperiores! Error, dolorum dignissimos 
            impedit optio ex consequatur dolorem itaque omnis, nesciunt quas illum, est dolores architecto similique.</p>
       </div>
